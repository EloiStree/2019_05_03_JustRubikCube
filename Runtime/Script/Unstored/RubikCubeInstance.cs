...
public class RubikCubeInstance : MonoBehaviour
{
    ...
    private static RubikCubeInstance m_cubeInScene;
    public static RubikCubeInstance GetRubixCubeInScene()
    {

        return m_cubeInScene;
    }
    public static RubikCubeInstance Get()
    {
        return m_cubeInScene;
    }
    ...
    {
        RubikCubeInstance previous = m_cubeInScene;
        RubikCubeInstance newCube = this;
        m_cubeInScene = newCube;

        Component[] objects = GameObject.FindObjectsByType<Component>( FindObjectsSortMode.None);
    ...
    internal void AddLocalSequence(string sequence)
    {
        m_rubikCube.AddLocalRotationSequence(sequence);
    }
    public void AddSequence(string sequence, Transform transform)
    {
        m_rubikCube.AddRotationSequence(sequence,transform);
    }
    public void SetWithSequence(string sequence, Transform transform)
    {
